 ...
 */
final class Version20201118131645 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, firstname, lastname, phone, is_enabled, token, created_at FROM user');
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, firstname VARCHAR(255) DEFAULT NULL COLLATE BINARY, lastname VARCHAR(255) DEFAULT NULL COLLATE BINARY, phone VARCHAR(10) DEFAULT NULL COLLATE BINARY, token VARCHAR(255) DEFAULT NULL COLLATE BINARY, is_enabled BOOLEAN NOT NULL, created_at DATETIME NOT NULL, is_banned BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, firstname, lastname, phone, is_enabled, token, created_at) SELECT id, email, roles, password, firstname, lastname, phone, is_enabled, token, created_at FROM __temp__user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , password VARCHAR(255) NOT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, phone VARCHAR(10) DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, is_enabled BOOLEAN DEFAULT \'0\' NOT NULL, created_at DATETIME DEFAULT \'0\' NOT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, firstname, lastname, phone, is_enabled, token, created_at) SELECT id, email, roles, password, firstname, lastname, phone, is_enabled, token, created_at FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
    }
