 ...
 */
final class Version20201113142545 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD COLUMN is_best BOOLEAN DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__commande_detail');
        $this->addSql('CREATE INDEX IDX_2C5284469E7BDFAB ON commande_detail (ma_commande_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__produit AS SELECT id, titre, soustitre, slug, couverture, image_1, image_2, image_3, description, prix FROM produit');
        ...
        $this->addSql('INSERT INTO produit (id, titre, soustitre, slug, couverture, image_1, image_2, image_3, description, prix) SELECT id, titre, soustitre, slug, couverture, image_1, image_2, image_3, description, prix FROM __temp__produit');
