 ...
 */
final class Version20201113081107 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__commande AS SELECT id, user_id, created_at, transporteur_titre, transporteur_prix, livraison, reference, stripe_session_id FROM commande');
        ...
        $this->addSql('INSERT INTO commande (id, user_id, created_at, transporteur_titre, transporteur_prix, livraison, reference, stripe_session_id) SELECT id, user_id, created_at, transporteur_titre, transporteur_prix, livraison, reference, stripe_session_id FROM __temp__commande');
