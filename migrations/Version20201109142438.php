 ...
 */
final class Version20201109142438 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__commande AS SELECT id, user_id, created_at, transporteur_titre, transporteur_prix, livraison, is_paid, reference FROM commande');
        $this->addSql('DROP TABLE commande');
        $this->addSql('CREATE TABLE commande (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, created_at DATETIME NOT NULL, transporteur_titre VARCHAR(255) NOT NULL COLLATE BINARY, transporteur_prix DOUBLE PRECISION NOT NULL, livraison CLOB NOT NULL COLLATE BINARY, is_paid BOOLEAN NOT NULL, reference VARCHAR(255) NOT NULL COLLATE BINARY, stripe_session_id VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_6EEAA67DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO commande (id, user_id, created_at, transporteur_titre, transporteur_prix, livraison, is_paid, reference) SELECT id, user_id, created_at, transporteur_titre, transporteur_prix, livraison, is_paid, reference FROM __temp__commande');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__commande AS SELECT id, user_id, created_at, transporteur_titre, transporteur_prix, livraison, is_paid, reference FROM commande');
        $this->addSql('DROP TABLE commande');
        $this->addSql('CREATE TABLE commande (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, created_at DATETIME NOT NULL, transporteur_titre VARCHAR(255) NOT NULL, transporteur_prix DOUBLE PRECISION NOT NULL, livraison CLOB NOT NULL, is_paid BOOLEAN NOT NULL, reference VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO commande (id, user_id, created_at, transporteur_titre, transporteur_prix, livraison, is_paid, reference) SELECT id, user_id, created_at, transporteur_titre, transporteur_prix, livraison, is_paid, reference FROM __temp__commande');
        $this->addSql('DROP TABLE __temp__commande');
        $this->addSql('CREATE INDEX IDX_6EEAA67DA76ED395 ON commande (user_id)');
        $this->addSql('DROP INDEX IDX_2C5284469E7BDFAB');
