 ...
 */
final class Version20201119133728 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, created_at DATETIME NOT NULL, transporteur_titre VARCHAR(255) NOT NULL COLLATE BINARY, transporteur_prix DOUBLE PRECISION NOT NULL, livraison CLOB NOT NULL COLLATE BINARY, reference VARCHAR(255) NOT NULL COLLATE BINARY, stripe_session_id VARCHAR(255) DEFAULT NULL COLLATE BINARY, state INTEGER NOT NULL, suivi VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_6EEAA67DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
