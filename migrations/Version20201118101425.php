 ...
 */
final class Version20201118101425 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN is_enabled BOOLEAN NOT NULL DEFAULT 0');
        $this->addSql('ALTER TABLE user ADD COLUMN token VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN created_at DATETIME NOT NULL DEFAULT 0');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        , password VARCHAR(255) NOT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, phone VARCHAR(10) DEFAULT NULL)');
